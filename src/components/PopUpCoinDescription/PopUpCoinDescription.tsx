...
const PopUpCoinDescription: React.FC<PropsTypes> = ({
  ...
  const showExistQuantity = () => (existingCoinFromProfile ? `${formatNumbersToPrettyStyle(convertQuantity(existingCoinFromProfile.quantity), 8)} ${existingCoinFromProfile.coin.symbol}` : '');
