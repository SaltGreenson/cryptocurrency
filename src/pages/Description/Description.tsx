    ...
    <div className={classes.container}>
      <div className={classes.heading}>
        <div className={classes.titleWrap}>
          ...
          <p
            className={alreadyInFavourite ? classesForFavourite.alreadyFavourite : classesForFavourite.favourite}
            onClick={() => {
        ...
        <div className={classes.descriptionWrap}>
          <div className={classes.descriptionElement}>
            <div className={classes.descriptionTitleWrap}>
              Volume
              {' '}
              <span className={classes.symbolWrap}>24h</span>
            </div>
        ...
        <div className={classes.descriptionWrap}>
          <div className={classes.descriptionElement}>
            ...
            <p className={classes.descriptionPrice}>
              {formatNumbersToPrettyStyle(+asset.supply, 2, 8)}
              {' '}
              {asset.symbol}
            </p>
          </div>
